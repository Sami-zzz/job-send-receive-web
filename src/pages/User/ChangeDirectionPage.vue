      ...
      >
        ...
        >
          <el-select
            ...
            placeholder="请选择更换后的方向"
          >
            <!-- 通过v-for将options容器中的数据展示在选项中 -->
            <el-option
...
<script>
import { getAllDirectionTest, changeDirection } from '../../../src/api';
export default {
  mounted () {
    this.getData()
  },
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          let params = {
            ...
            type: 1,
            directionId: this.ruleForm.apply
          };
          changeDirection(params).then((res) => {
            console.log(params);
            alert("submit!");
          })
        } else {
